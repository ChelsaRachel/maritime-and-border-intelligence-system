...
**Access token:** Tactical maps inherit the same canonical env contract from `skills/reactjs-map/SKILL.md` — use `MAPBOX_ACCESS_TOKEN=<MAPBOX_ACCESS_TOKEN_FROM_ENV>`.
