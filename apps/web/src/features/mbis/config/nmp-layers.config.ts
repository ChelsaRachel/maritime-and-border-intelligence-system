...
export const NMP_LAYER_REGISTRY: INmpLayerRegistryEntry[] = [
  ...
  { id: 'mbis-nmp-route-arrow-symbol', source: NMP_SOURCES.routeArrowPoints, type: 'symbol', group: 'routes', paintPreset: 'routeArrows', defaultVisible: true, layout: { 'icon-image': 'nmp-route-chevron', 'icon-size': ['interpolate', ['linear'], ['zoom'], 2, 0.32, 7, 0.52], 'icon-rotate': ['get', 'bearing'], 'icon-rotation-alignment': 'map', 'icon-pitch-alignment': 'map', 'icon-allow-overlap': true, 'icon-ignore-placement': true } },
  { id: 'mbis-nmp-aircraft-route-arrow-symbol', source: NMP_SOURCES.aircraftRouteArrowPoints, type: 'symbol', group: 'aircraft', paintPreset: 'airRouteArrows', defaultVisible: true, layout: { 'icon-image': 'nmp-route-chevron', 'icon-size': ['interpolate', ['linear'], ['zoom'], 2, 0.27, 7, 0.44], 'icon-rotate': ['get', 'bearing'], 'icon-rotation-alignment': 'map', 'icon-pitch-alignment': 'map', 'icon-allow-overlap': true, 'icon-ignore-placement': true } },
